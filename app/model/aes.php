...
class aes extends Model
{
	...
	public function __construct(){
		$this->iv = config('app.token_iv');
		$this->key = config('app.token_key');
	}
    /**
     * pkcs7补码
    ...
    public function aes128cbcHexDecrypt($encryptedText, $iv, $key) {
    	$iv = $this->iv;
    	$key = $this->key;
    ...
    public function aes128cbcEncrypt($str, $iv, $key ) {    // $this->addPkcs7Padding($str,16)
    	$iv = $this->iv;
    	$key = $this->key;
